...
public class EditController implements Initializable {
    ...
    private void attachOnClickListener(PaymentRecord paymentRecord, TextField... textFields) {
        for (TextField textField: textFields) {
            textField.addEventHandler(MouseEvent.MOUSE_CLICKED, event -> {
                EditRecordController.setRecord(paymentRecord);
                ViewFactory.getInstance().showEditRecordPaymentsReceivedWindow();
            });
        }
    }
